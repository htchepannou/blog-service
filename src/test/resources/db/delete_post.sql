...
-- should_delete_repost
INSERT INTO post (id, blog_id, user_id, title, type, status, deleted, created, updated, published)
VALUES(2000, 200, 200, 'hello world', 1, 1, true, '2015-01-10 03:14:07', '2038-01-12 03:14:07', '2038-01-19 03:14:07');
...
INSERT INTO post (id, blog_id, user_id, title, type, status, deleted, created, updated, published)
VALUES(3000, 300, 300, 'hello world', 1, 1, true, '2015-01-10 03:14:07', '2038-01-12 03:14:07', '2038-01-19 03:14:07');

INSERT INTO post_entry(blog_id, post_fk, posted) VALUES(300, 3000, now());

-- should_return_404_when_deleted
INSERT INTO post (id, blog_id, user_id, title, type, status, deleted, created, updated, published)
VALUES(4000, 400, 400, 'hello world', 1, 1, false, '2015-01-10 03:14:07', '2038-01-12 03:14:07', '2038-01-19 03:14:07');
